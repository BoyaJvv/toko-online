...
<div class="text-center">
      ...
      <div class="table-responsive small container px-4 px-lg-5 me-auto mb-2 mb-lg-0 ms-lg-4">
        <table class="table table-striped table-sm me-auto mb-2 mb-lg-0 ms-lg-4">
          <thead>
          <tr>
